...
then
    ...
    python run_ensemble.py ${1} ${2} ${3} ${4} ${5} 2 ${7} ${8}
...
then
    ...
    # feed in value for theta 
    python run_ensemble.py ${1} ${2} ${3} ${4} ${5} 2 ${7} ${8}  --VRA_reject
else
    ...
    #     "10" \
    # )
    # log_file="logs/${file_label}.log"
    # sbatch --job-name="vra climb" --output="${log_file}" \
    #     --error="${log_file}" vra_climb.sh ${1} ${2} ${3} ${4} ${5} ${7} ${8} $log_file 10
    ...
    # log_file="logs/${file_label}.log"
    # sbatch --job-name="vra climb" --output="${log_file}" \
    #     --error="${log_file}" vra_climb.sh ${1} ${2} ${3} ${4} ${5} ${7} ${8} $log_file 50
    ...
    log_file="logs/${file_label}.log"
    sbatch --job-name="vra climb" --output="${log_file}" \
        --error="${log_file}" vra_climb.sh ${1} ${2} ${3} ${4} ${5} ${7} ${8} $log_file 100
fi
