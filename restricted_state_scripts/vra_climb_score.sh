...
log_file="restricted_state_scripts/score_logs/${file_label}.log"
python collect_restricted_scores.py $state $map $n $county_weight $county_sub_weight $theta $bvap $biden  --VRA_climb
