...
job_name="MI_effective_embed_score_$(date '+%d-%m-%Y@%H:%M:%SET')"
...
# on line 167 or so
running_script_name="single_run_embed_score.sh"


# ==================
# RUNNING PARAMETERS
# ==================
log_dir="embed_score_logs"
state=Michigan_restricted
maps=("house_1" "house_2" "senate")
county_weights=0 #(0 .33 .66 1)
county_sub_weights=.66 #(0 .33 .66 1)
vra_types=(0 1 2)
bvaps=(.4 .44) #(.4 .44 .46 .5)
bidens=(.48 .5) #(.5 .53 .54 .55)
N=100000
